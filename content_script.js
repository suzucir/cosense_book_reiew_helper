...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  function getBookInfo() {
    ...
    const publisher = document.getElementById("rpi-attribute-book_details-publisher")?.textContent.replace(/(?:^|\s)(Publisher|出版社)(?::|\s)\s*/i, '').trim();
    const publishedDate = document.getElementById("rpi-attribute-book_details-publication_date")?.textContent.replace(/(?:^|\s)(Published|発売日)(?::|\s)\s*/i, '').trim();
